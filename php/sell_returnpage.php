...
<div class="text-center">
    <br><br><br>
    <h1>Thank You<span class="name"> <?php echo $_SESSION['first_name'].$_SESSION['last_name']; ?></span> for using The Preloved Store</h2>
</br></br>
    <h3>Ad posted successfully!</h3>
</div>
<br><br><br><br><br><br><br><br><br><br><br><br><br>
<div class="con">
<p class="last_para">Go to <a href="#">SHOP</a> now to see your posted product!!<p>
</div>>
